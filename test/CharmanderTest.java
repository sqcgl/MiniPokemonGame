...
public class CharmanderTest {
    ...
    public void testLearnMoveByLevel() {
        Charmander higherLevelCharmander = new Charmander(7);
    ...
    public void testEvolve() {
        Charmander charmanderBeforeEvolve = new Charmander(7);
        ...
        Charmander charmanderToEvolve = new Charmander(8);
        ...
        Charmeleon charmeleonToEvolve = new Charmeleon(12);
